	...
	protected $ebnf = '
{
	...
	"T_SIMPLE_EXPRESSION": {"|": ["<T_FN_DEF>", "<T_ASSIGNMENT>", "<T_DESTRUCTURING_ASSIGNMENT>", "<T_OPERATION>", "<T_PCONDITION>", "<T_IF_THEN>", "<T_FNCALL>", "<T_FNCSCALL>", "<T_RETURN>", "<T_IDENTIFIER>", "<T_LITERAL>", "<T_CONST_DEF>", "<T_CONST>"]},
